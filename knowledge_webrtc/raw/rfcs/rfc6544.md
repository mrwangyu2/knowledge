...
Status of This Memo
   ...
   [http://www.rfc-editor.org/info/rfc6544](https://www.rfc-editor.org/info/rfc6544).

Rosenberg, et al.            Standards Track                    \[Page 1\]

* * *

[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
...
Table of Contents
   ...
   [2](#section-2). Terminology .....................................................[5](#page-5)
   [3](#section-3). Overview of Operation ...........................................[5](#page-5)
   [4](#section-4). Sending the Initial Offer .......................................[7](#page-7)
      [4.1](#section-4.1). Gathering Candidates .......................................[7](#page-7)
      [4.2](#section-4.2). Prioritization .............................................[8](#page-8)
      [4.3](#section-4.3). Choosing Default Candidates ...............................[10](#page-10)
      [4.4](#section-4.4). Lite Implementation Requirements ..........................[10](#page-10)
      [4.5](#section-4.5). Encoding the SDP ..........................................[11](#page-11)
   [5](#section-5). Candidate Collection Techniques ................................[12](#page-12)
      [5.1](#section-5.1). Host Candidates ...........................................[12](#page-12)
      [5.2](#section-5.2). Server Reflexive Candidates ...............................[13](#page-13)
      [5.3](#section-5.3). NAT-Assisted Candidates ...................................[13](#page-13)
      [5.4](#section-5.4). UDP-Tunneled Candidates ...................................[14](#page-14)
      [5.5](#section-5.5). Relayed Candidates ........................................[15](#page-15)
   [6](#section-6). Receiving the Initial Offer and Answer .........................[15](#page-15)
      [6.1](#section-6.1). Considerations with Two Lite Agents .......................[16](#page-16)
      [6.2](#section-6.2). Forming the Check Lists ...................................[16](#page-16)
   [7](#section-7). Connectivity Checks ............................................[17](#page-17)
      [7.1](#section-7.1). STUN Client Procedures ....................................[17](#page-17)
      [7.2](#section-7.2). STUN Server Procedures ....................................[18](#page-18)
   [8](#section-8). Concluding ICE Processing ......................................[18](#page-18)
   [9](#section-9). Subsequent Offer/Answer Exchanges ..............................[18](#page-18)
      [9.1](#section-9.1). Updated Offer .............................................[18](#page-18)
      [9.2](#section-9.2). ICE Restarts ..............................................[19](#page-19)
   [10](#section-10). Media Handling ................................................[19](#page-19)
      [10.1](#section-10.1). Sending Media ............................................[19](#page-19)
      [10.2](#section-10.2). Receiving Media ..........................................[20](#page-20)
   [11](#section-11). Connection Management .........................................[20](#page-20)
      [11.1](#section-11.1). Connections Formed during Connectivity Checks ............[20](#page-20)
      [11.2](#section-11.2). Connections Formed for Gathering Candidates ..............[21](#page-21)
   [12](#section-12). Security Considerations .......................................[22](#page-22)
   [13](#section-13). IANA Considerations ...........................................[23](#page-23)
   [14](#section-14). Acknowledgements ..............................................[23](#page-23)
   [15](#section-15). References ....................................................[23](#page-23)
      [15.1](#section-15.1). Normative References .....................................[23](#page-23)
      [15.2](#section-15.2). Informative References ...................................[24](#page-24)
   [Appendix A](#appendix-A).  Limitations of ICE TCP ...............................[26](#page-26)
   [Appendix B](#appendix-B).  Implementation Considerations for BSD Sockets ........[27](#page-27)
   [Appendix C](#appendix-C).  SDP Examples .........................................[28](#page-28)
...
[1](#section-1).  Introduction
   ...
   Interactive Connectivity Establishment (ICE) \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] defines a
   mechanism for NAT traversal for multimedia communication protocols
   based on the offer/answer model \[[RFC3264](./rfc3264 "\"An Offer/Answer Model with Session Description Protocol (SDP)\"")\] of session negotiation.
   ...
   (STUN) \[[RFC5389](./rfc5389 "\"Session Traversal Utilities for NAT (STUN)\"")\].  However, ICE only defines procedures for UDP-based
   transport protocols.
   ...
   \[[RFC4975](./rfc4975 "\"The Message Session Relay Protocol (MSRP)\"")\].  For these protocols to work in the presence of NAT,
   unless they define their own NAT traversal mechanisms, ICE support
   for TCP is needed.  In addition, RTP can also run over TCP \[[RFC4571](./rfc4571 "\"Framing Real-time Transport Protocol (RTP) and RTP Control Protocol (RTCP) Packets over Connection- Oriented Transport\"")\].
   ...
   Traversal Using Relays around NAT (TURN) \[[RFC5766](./rfc5766 "\"Traversal Using Relays around NAT (TURN): Relay Extensions to Session Traversal Utilities for NAT (STUN)\"")\].  In this case,
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   ICE.  The base behavior of ICE \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] remains unchanged except for
   ...
   ICE.  Discussion about this topic can be found in [Appendix A](#appendix-A).

[2](#section-2).  Terminology

   The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT",
   "SHOULD", "SHOULD NOT", "RECOMMENDED", "NOT RECOMMENDED", "MAY", and
   "OPTIONAL" in this document are to be interpreted as described in [RFC](./rfc2119)
   [2119](./rfc2119) \[[RFC2119](./rfc2119 "\"Key words for use in RFCs to Indicate Requirement Levels\"")\].

   This document uses the same terminology as ICE (see [Section 3 of
   \[RFC5245\]](./rfc5245#section-3)).
...
[3](#section-3).  Overview of Operation
   ...
   [Section 5](#section-5)).  Connections to servers used for relayed and server
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   described in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] and is done using the magic cookie and other
   ...
   provided in [RFC 4571](./rfc4571) \[[RFC4571](./rfc4571 "\"Framing Real-time Transport Protocol (RTP) and RTP Control Protocol (RTCP) Packets over Connection- Oriented Transport\"")\], even if the application layer
   protocol is not RTP.

   When Transport Layer Security (TLS) or Datagram Transport Layer
   Security (DTLS) is used, they are also run over the [RFC 4571](./rfc4571) framing
   ...
   the left side and without it on the right side.
            ...
            +----------+----------+     +----------+----------+
            |                     |     |                     |
            |      [RFC 4571](./rfc4571)       |     |      [RFC 4571](./rfc4571)       |
            +---------------------+     +---------------------+
            |                     |     |                     |
            |         TCP         |     |         TCP         |
            +---------------------+     +---------------------+
...
[4](#section-4).  Sending the Initial Offer
...
[4.1](#section-4.1).  Gathering Candidates
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   [Section 5.1](#section-5.1).  Then, each agent SHOULD "obtain" (allocate a
   ...
   UDP-tunneled candidates (see [Section 5.2](#section-5.2), [Section 5.3](#section-5.3), and
   [Section 5.4](#section-5.4)).  The mechanisms for establishing these candidates and
   ...
   candidates for each component as described in [Section 5.5](#section-5.5).  Each
   ...
   connections open until ICE processing has completed.  See [Appendix B](#appendix-B)
   ...
   at one every Ta milliseconds (see [Section 16 of \[RFC5245\]](./rfc5245#section-16)).  This
...
[4.2](#section-4.2).  Prioritization
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   In [Section 4.1.2.1 of \[RFC5245\]](./rfc5245#section-4.1.2.1), a recommended formula for UDP ICE
   ...
   this document (see [Section 5](#section-5)) are 105 for NAT-assisted candidates and
...
[4.3](#section-4.3).  Choosing Default Candidates
   ...
   candidate and use \[[RFC4145](./rfc4145 "\"TCP-Based Media Transport in the Session Description Protocol (SDP)\"")\] "setup" attribute value "active".  This
...
[4.4](#section-4.4).  Lite Implementation Requirements

   If an offerer meets the criteria for the lite mode as described in
   [Appendix A of \[RFC5245\]](./rfc5245#appendix-A) (i.e., it will always have a public, globally
   ...
   mode in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] also apply to TCP candidates.  If UDP and TCP
...
[4.5](#section-4.5).  Encoding the SDP

   TCP-based candidates are encoded into a=candidate lines like the UDP
   candidates described in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].  However, the transport protocol
   (i.e., value of the transport-extension token defined in [\[RFC5245\],
   Section 15.1](./rfc5245#section-15.1)) is set to "TCP" and the connection type (active,
   ...
   \[[RFC5234](./rfc5234 "\"Augmented BNF for Syntax Specifications: ABNF\"")\] is then:
   ...
   a=setup and a=connection attributes from [RFC 4145](./rfc4145) \[[RFC4145](./rfc4145 "\"TCP-Based Media Transport in the Session Description Protocol (SDP)\"")\],
   ...
   meet the constraints in [RFC 4145](./rfc4145) based on the value in the offer.

   If an agent is utilizing SRTP \[[RFC3711](./rfc3711 "\"The Secure Real-time Transport Protocol (SRTP)\"")\], it MAY include a mix of UDP
   ...
   SHOULD be avoided.  In the case of DTLS-SRTP \[[RFC5764](./rfc5764 "\"Datagram Transport Layer Security (DTLS) Extension to Establish Keys for the Secure Real-time Transport Protocol (SRTP)\"")\], the
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   constructed as described in [RFC 4572](./rfc4572) \[[RFC4572](./rfc4572 "\"Connection-Oriented Media Transport over the Transport Layer Security (TLS) Protocol in the Session Description Protocol (SDP)\"")\].  The directionality
...
[5](#section-5).  Candidate Collection Techniques
   ...
   ([Section 5.1](#section-5.1)) considered mandatory.
   ...
   other techniques, e.g., TURN-IPv6 \[[RFC6156](./rfc6156 "\"Traversal Using Relays around NAT (TURN) Extension for IPv6\"")\], Teredo \[[RFC4380](./rfc4380 "\"Teredo: Tunneling IPv6 over UDP through Network Address Translations (NATs)\"")\], or
   SOCKS IPv4-IPv6 gatewaying \[[RFC3089](./rfc3089 "\"A SOCKS-based IPv6/IPv4 Gateway Mechanism\"")\], for obtaining IPv6 candidates.
...
[5.1](#section-5.1).  Host Candidates
...
[5.2](#section-5.2).  Server Reflexive Candidates
   ...
   behavior \[[RFC5382](./rfc5382 "\"NAT Behavioral Requirements for TCP\"")\] and also on whether the NATs and hosts support the
   TCP simultaneous-open technique.

   Obtaining server reflexive passive candidates may require initiating
   connections from host's passive candidates; see [Appendix B](#appendix-B) for
   ...
   STUN.  Its TCP-specific behavior is described in \[[RFC5389](./rfc5389 "\"Session Traversal Utilities for NAT (STUN)\"")\], [Section](#section-7.2.2)
   [7.2.2](#section-7.2.2).

[5.3](#section-5.3).  NAT-Assisted Candidates
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   priority (as described in [Section 4.2](#section-4.2)) and hence are tested before
   the server reflexive candidates.

   Currently, the Universal Plug and Play (UPnP) forum's Internet
   Gateway Device (IGD) protocol \[[UPnP-IGD](#ref-UPnP-IGD "\"Internet Gateway Device (IGD) Standardized Device Control Protocol V 1.0\"")\] and the NAT Port Mapping
   Protocol (PMP) \[[NAT-PMP](#ref-NAT-PMP "\"NAT Port Mapping Protocol (NAT-PMP)\"")\] are widely supported NAT-assisted
   techniques.  Other known protocols include Port Control Protocol
   (PCP) \[[PCP-BASE](#ref-PCP-BASE "\"Port Control Protocol (PCP)\"")\], SOCKS \[[RFC1928](./rfc1928 "\"SOCKS Protocol Version 5\"")\], Realm Specific IP (RSIP)
   \[[RFC3103](./rfc3103 "\"Realm Specific IP: Protocol Specification\"")\], and Simple Middlebox Configuration (SIMCO) \[[RFC4540](./rfc4540 "\"NEC's Simple Middlebox Configuration (SIMCO) Protocol Version 3.0\"")\].
   Also, the Middlebox Communications (MIDCOM) MIB \[[RFC5190](./rfc5190 "\"Definitions of Managed Objects for Middlebox Communication\"")\] defines a
   mechanism based on the Simple Network Management Protocol (SNMP) for
   controlling NATs.

[5.4](#section-5.4).  UDP-Tunneled Candidates
   ...
   For example, the Teredo protocol \[[RFC4380](./rfc4380 "\"Teredo: Tunneling IPv6 over UDP through Network Address Translations (NATs)\"")\] \[[RFC6081](./rfc6081 "\"Teredo Extensions\"")\] provides
...
[5.5](#section-5.5).  Relayed Candidates
   ...
   TCP \[[RFC6062](./rfc6062 "\"Traversal Using Relays around NAT (TURN) Extensions for TCP Allocations\"")\] and SOCKS \[[RFC1928](./rfc1928 "\"SOCKS Protocol Version 5\"")\] (which can also be used for IPv4-
   IPv6 gatewaying \[[RFC3089](./rfc3089 "\"A SOCKS-based IPv6/IPv4 Gateway Mechanism\"")\]).  It is also possible to use a Secure
   SHell (SSH) \[[RFC4251](./rfc4251 "\"The Secure Shell (SSH) Protocol Architecture\"")\] tunnel as a relayed candidate if a suitable
   server is available and the server permits this.

[6](#section-6).  Receiving the Initial Offer and Answer
   ...
   check for ice-mismatch described in [Section 5.1 of \[RFC5245\]](./rfc5245#section-5.1)) and
   agent roles are determined.  Candidates are gathered using the
   techniques described in [Section 5](#section-5) and prioritized as described in
   [Section 4.2](#section-4.2).  Default candidates are selected taking into account the
   considerations in [Section 4.3](#section-4.3).  The SDP answer is encoded as in
   [Section 4.3 of \[RFC5245\]](./rfc5245#section-4.3), with the exception of TCP candidates whose
   encoding is described in [Section 4.5](#section-4.5).
   ...
   procedures defined in \[[RFC4145](./rfc4145 "\"TCP-Based Media Transport in the Session Description Protocol (SDP)\"")\] to select the most preferred
...
[6.1](#section-6.1).  Considerations with Two Lite Agents

   If both agents are using the lite mode and if the offerer uses the
   a=setup:active attribute \[[RFC4145](./rfc4145 "\"TCP-Based Media Transport in the Session Description Protocol (SDP)\"")\] in the new offer, the offerer MAY
   ...
   implementation considerations, see [Appendix A of \[RFC5245\]](./rfc5245#appendix-A).

[6.2](#section-6.2).  Forming the Check Lists
...
[7](#section-7).  Connectivity Checks
   ...
   connectivity checks, as described in [Section 5.8 of \[RFC5245\]](./rfc5245#section-5.8), based
   on the priority order.

[7.1](#section-7.1).  STUN Client Procedures
   ...
   defined in [RFC 4571](./rfc4571) \[[RFC4571](./rfc4571 "\"Framing Real-time Transport Protocol (RTP) and RTP Control Protocol (RTCP) Packets over Connection- Oriented Transport\"")\] for the duration this connection
   remains open.  The STUN Binding requests and responses are sent on
   top of this shim, so that the length field defined in [RFC 4571](./rfc4571)
   ...
   Failed in the check list.  See [Section 7.2.2 of \[RFC5389\]](./rfc5389#section-7.2.2) for more
...
[7.2](#section-7.2).  STUN Server Procedures
   ...
   framing defined in [RFC 4571](./rfc4571) \[[RFC4571](./rfc4571 "\"Framing Real-time Transport Protocol (RTP) and RTP Control Protocol (RTCP) Packets over Connection- Oriented Transport\"")\] for the lifetime of this
   ...
   described in [Section 10.2](#section-10.2).
...
[9](#section-9).  Subsequent Offer/Answer Exchanges

[9.1](#section-9.1).  Updated Offer
   ...
   connection-oriented media \[[RFC4145](./rfc4145 "\"TCP-Based Media Transport in the Session Description Protocol (SDP)\"")\] are used to signal that an
...
[10](#section-10).  Media Handling

[10.1](#section-10.1).  Sending Media
   ...
   The framing defined in [RFC 4571](./rfc4571) MUST be used when sending media.  For
   media streams that are not RTP-based and do not normally use [RFC](./rfc4571)
   [4571](./rfc4571), the agent treats the media stream as a byte stream and assumes
   ...
   a payload in the [RFC 4571](./rfc4571) frames, including the length.  Next, the
   sender checks to see if the resulting set of bytes would be viewed as
   a STUN packet based on the rules in Sections [6](#section-6) and [8](#section-8) of \[[RFC5389](./rfc5389 "\"Session Traversal Utilities for NAT (STUN)\"")\].
   ...
   permitted to flow, as defined in the ICE specification \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].
   The TLS or DTLS-SRTP handshakes occur on top of the [RFC 4571](./rfc4571) shim and
...
[10.2](#section-10.2).  Receiving Media

   The framing defined in [RFC 4571](./rfc4571) MUST be used when receiving media.
   For media streams that are not RTP-based and do not normally use [RFC](./rfc4571)
   [4571](./rfc4571), the agent extracts the payload of each [RFC 4571](./rfc4571) frame and
   determines if it is a STUN or an application-layer data based on the
   procedures in ICE \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].  If media is being protected with DTLS-
   SRTP, the DTLS, RTP, and STUN packets are demultiplexed as described
   in [Section 5.1.2 of \[RFC5764\]](./rfc5764#section-5.1.2).
...
[11](#section-11).  Connection Management

[11.1](#section-11.1).  Connections Formed during Connectivity Checks
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   If the TCP connection is established, the framing of [RFC 4571](./rfc4571) is
   ...
   mapping properties \[[RFC5382](./rfc5382 "\"NAT Behavioral Requirements for TCP\"")\].

[11.2](#section-11.2).  Connections Formed for Gathering Candidates
...
[12](#section-12).  Security Considerations
   ...
   protocol used with ICE, such as SIP \[[RFC3261](./rfc3261 "\"SIP: Session Initiation Protocol\"")\].  This shared secret,
   in turn, is protected by that protocol exchange.  In the case of SIP,
   the usage of the SIP Secure (SIPS) \[[RFC3261](./rfc3261 "\"SIP: Session Initiation Protocol\"")\] mechanism is
   ...
   \[RFC5245\]](./rfc5245#section-18.5.2).  The same considerations apply to TCP, but the
   ...
   ICE prevents them are described in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].  Those considerations
...
[13](#section-13).  IANA Considerations
   ...
   Approval \[[RFC5226](./rfc5226)\].  Assignments consist of an extension token (as
   defined in [Section 15.1 of \[RFC5245\]](./rfc5245#section-15.1)) and a reference to the document
   defining the extension.

   Token   Reference
   -----   ---------
   UDP     [RFC 5245, Section 15.1](./rfc5245#section-15.1)
   TCP     [RFC 6544, Section 4.5](./rfc6544#section-4.5)
...
[15.1](#section-15.1).  Normative References
   ...
   \[RFC3711\]   Baugher, M., McGrew, D., Naslund, M., Carrara, E., and K.
               ...
               (SRTP)", [RFC 3711](./rfc3711), March 2004.

   \[RFC4145\]   Yon, D. and G. Camarillo, "TCP-Based Media Transport in
               the Session Description Protocol (SDP)", [RFC 4145](./rfc4145),
               September 2005.
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   \[RFC4571\]   Lazzaro, J., "Framing Real-time Transport Protocol (RTP)
               ...
               Oriented Transport", [RFC 4571](./rfc4571), July 2006.

   \[RFC4572\]   Lennox, J., "Connection-Oriented Media Transport over the
               Transport Layer Security (TLS) Protocol in the Session
               Description Protocol (SDP)", [RFC 4572](./rfc4572), July 2006.
   ...
   \[RFC5764\]   McGrew, D. and E. Rescorla, "Datagram Transport Layer
               ...
               Secure Real-time Transport Protocol (SRTP)", [RFC 5764](./rfc5764),
               May 2010.

   \[RFC5766\]   Mahy, R., Matthews, P., and J. Rosenberg, "Traversal
               Using Relays around NAT (TURN): Relay Extensions to
               Session Traversal Utilities for NAT (STUN)", [RFC 5766](./rfc5766),
               April 2010.
...
[RFC 6544](./rfc6544)                         ICE TCP                      March 2012
   ...
   \[RFC1928\]   Leech, M., Ganis, M., Lee, Y., Kuris, R., Koblas, D., and
               L. Jones, "SOCKS Protocol Version 5", [RFC 1928](./rfc1928),
               March 1996.

   \[RFC3089\]   Kitamura, H., "A SOCKS-based IPv6/IPv4 Gateway
               Mechanism", [RFC 3089](./rfc3089), April 2001.
   ...
   \[RFC6062\]   Perreault, S. and J. Rosenberg, "Traversal Using Relays
               ...
               [RFC 6062](./rfc6062), November 2010.

   \[RFC6081\]   Thaler, D., "Teredo Extensions", [RFC 6081](./rfc6081), January 2011.

   \[RFC6156\]   Camarillo, G., Novo, O., and S. Perreault, "Traversal
               Using Relays around NAT (TURN) Extension for IPv6",
               [RFC 6156](./rfc6156), April 2011.
...
[Appendix A](#appendix-A).  Limitations of ICE TCP
   ...
   It has been reported in \[[IMC05](#ref-IMC05 "\"Characterization and Measurement of TCP Traversal through NATs and Firewalls\"")\] that with the population of NATs
   ...
   by \[[RFC5382](./rfc5382 "\"NAT Behavioral Requirements for TCP\"")\] and operating system TCP stacks are fixed, the success
   ...
   described in Figure 1 of \[[RFC6081](./rfc6081 "\"Teredo Extensions\"")\].

   Finally, it should be noted that implementing various techniques
   listed in [Section 5](#section-5) should increase the success probability, but many
...
[Appendix B](#appendix-B).  Implementation Considerations for BSD Sockets
   ...
   for i in 0 to MAX
      sock\_i = socket()
      set(sock\_i, SO\_REUSEADDR)
      bind(sock\_i, local)

   listen(sock\_0)
   connect(sock\_1, stun)
   connect(sock\_2, remote\_a)
   connect(sock\_3, remote\_b)
...
[Appendix C](#appendix-C).  SDP Examples
  ...
  topology of Figure 8 in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\], with the same IP addresses.  The
