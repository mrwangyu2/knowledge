...
Copyright Notice
   ...
   include Simplified BSD License text as described in [Section 4](#section-4).e of

Wing, et al.                 Standards Track                    \[Page 1\]

* * *

[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
...
Table of Contents
   ...
   [2](#section-2).  Scope  . . . . . . . . . . . . . . . . . . . . . . . . . . . .  [5](#page-5)
     [2.1](#section-2.1).  Deployment Scenarios . . . . . . . . . . . . . . . . . . .  [5](#page-5)
     [2.2](#section-2.2).  Supported Protocols  . . . . . . . . . . . . . . . . . . .  [5](#page-5)
     [2.3](#section-2.3).  Single-Homed Customer Premises Network . . . . . . . . . .  [5](#page-5)
   [3](#section-3).  Terminology  . . . . . . . . . . . . . . . . . . . . . . . . .  [6](#page-6)
   4.  Relationship between PCP Server and Its PCP-Controlled
       Device . . . . . . . . . . . . . . . . . . . . . . . . . . . . [10](#page-10)
   [5](#section-5).  Note on Fixed-Size Addresses . . . . . . . . . . . . . . . . . [10](#page-10)
   [6](#section-6).  Protocol Design Note . . . . . . . . . . . . . . . . . . . . . [11](#page-11)
   [7](#section-7).  Common Request and Response Header Format  . . . . . . . . . . [13](#page-13)
     [7.1](#section-7.1).  Request Header . . . . . . . . . . . . . . . . . . . . . . [14](#page-14)
     [7.2](#section-7.2).  Response Header  . . . . . . . . . . . . . . . . . . . . . [15](#page-15)
     [7.3](#section-7.3).  Options  . . . . . . . . . . . . . . . . . . . . . . . . . [16](#page-16)
     [7.4](#section-7.4).  Result Codes . . . . . . . . . . . . . . . . . . . . . . . [19](#page-19)
   [8](#section-8).  General PCP Operation  . . . . . . . . . . . . . . . . . . . . [20](#page-20)
     [8.1](#section-8.1).  General PCP Client: Generating a Request . . . . . . . . . [21](#page-21)
       [8.1.1](#section-8.1.1).  PCP Client Retransmission  . . . . . . . . . . . . . . [22](#page-22)
     [8.2](#section-8.2).  General PCP Server: Processing a Request . . . . . . . . . [24](#page-24)
     [8.3](#section-8.3).  General PCP Client: Processing a Response  . . . . . . . . [25](#page-25)
     [8.4](#section-8.4).  Multi-Interface Issues . . . . . . . . . . . . . . . . . . [27](#page-27)
     [8.5](#section-8.5).  Epoch  . . . . . . . . . . . . . . . . . . . . . . . . . . [27](#page-27)
   [9](#section-9).  Version Negotiation  . . . . . . . . . . . . . . . . . . . . . [29](#page-29)
   [10](#section-10). Introduction to MAP and PEER Opcodes . . . . . . . . . . . . . [30](#page-30)
     [10.1](#section-10.1). For Operating a Server . . . . . . . . . . . . . . . . . . [33](#page-33)
     [10.2](#section-10.2). For Operating a Symmetric Client/Server  . . . . . . . . . [35](#page-35)
     [10.3](#section-10.3). For Reducing NAT or Firewall Keepalive Messages  . . . . . [37](#page-37)
     [10.4](#section-10.4). For Restoring Lost Implicit TCP Dynamic Mapping State  . . [38](#page-38)
   [11](#section-11). MAP Opcode . . . . . . . . . . . . . . . . . . . . . . . . . . [39](#page-39)
     [11.1](#section-11.1). MAP Operation Packet Formats . . . . . . . . . . . . . . . [40](#page-40)
     [11.2](#section-11.2). Generating a MAP Request . . . . . . . . . . . . . . . . . [43](#page-43)
       [11.2.1](#section-11.2.1). Renewing a Mapping . . . . . . . . . . . . . . . . . . [44](#page-44)
     [11.3](#section-11.3). Processing a MAP Request . . . . . . . . . . . . . . . . . [44](#page-44)
     [11.4](#section-11.4). Processing a MAP Response  . . . . . . . . . . . . . . . . [48](#page-48)
     [11.5](#section-11.5). Address Change Events  . . . . . . . . . . . . . . . . . . [49](#page-49)
     [11.6](#section-11.6). Learning the External IP Address Alone . . . . . . . . . . [50](#page-50)
   [12](#section-12). PEER Opcode  . . . . . . . . . . . . . . . . . . . . . . . . . [50](#page-50)
     [12.1](#section-12.1). PEER Operation Packet Formats  . . . . . . . . . . . . . . [51](#page-51)
     [12.2](#section-12.2). Generating a PEER Request  . . . . . . . . . . . . . . . . [54](#page-54)
     [12.3](#section-12.3). Processing a PEER Request  . . . . . . . . . . . . . . . . [55](#page-55)
     [12.4](#section-12.4). Processing a PEER Response . . . . . . . . . . . . . . . . [56](#page-56)
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   [13](#section-13). Options for MAP and PEER Opcodes . . . . . . . . . . . . . . . [57](#page-57)
     [13.1](#section-13.1). THIRD\_PARTY Option for MAP and PEER Opcodes  . . . . . . . [57](#page-57)
     [13.2](#section-13.2). PREFER\_FAILURE Option for MAP Opcode . . . . . . . . . . . [59](#page-59)
     [13.3](#section-13.3). FILTER Option for MAP Opcode . . . . . . . . . . . . . . . [61](#page-61)
   [14](#section-14). Rapid Recovery . . . . . . . . . . . . . . . . . . . . . . . . [63](#page-63)
     [14.1](#section-14.1). ANNOUNCE Opcode  . . . . . . . . . . . . . . . . . . . . . [64](#page-64)
       [14.1.1](#section-14.1.1). ANNOUNCE Operation . . . . . . . . . . . . . . . . . . [65](#page-65)
       14.1.2. Generating and Processing a Solicited ANNOUNCE
               Message  . . . . . . . . . . . . . . . . . . . . . . . [65](#page-65)
       14.1.3. Generating and Processing an Unsolicited ANNOUNCE
               Message  . . . . . . . . . . . . . . . . . . . . . . . [66](#page-66)
     [14.2](#section-14.2). PCP Mapping Update . . . . . . . . . . . . . . . . . . . . [67](#page-67)
   [15](#section-15). Mapping Lifetime and Deletion  . . . . . . . . . . . . . . . . [69](#page-69)
     [15.1](#section-15.1). Lifetime Processing for the MAP Opcode . . . . . . . . . . [71](#page-71)
   [16](#section-16). Implementation Considerations  . . . . . . . . . . . . . . . . [72](#page-72)
     [16.1](#section-16.1). Implementing MAP with EDM Port-Mapping NAT . . . . . . . . [72](#page-72)
     [16.2](#section-16.2). Lifetime of Explicit and Implicit Dynamic Mappings . . . . [72](#page-72)
     [16.3](#section-16.3). PCP Failure Recovery . . . . . . . . . . . . . . . . . . . [72](#page-72)
       [16.3.1](#section-16.3.1). Recreating Mappings  . . . . . . . . . . . . . . . . . [73](#page-73)
       [16.3.2](#section-16.3.2). Maintaining Mappings . . . . . . . . . . . . . . . . . [73](#page-73)
       [16.3.3](#section-16.3.3). SCTP . . . . . . . . . . . . . . . . . . . . . . . . . [74](#page-74)
     [16.4](#section-16.4). Source Address Replicated in PCP Header  . . . . . . . . . [75](#page-75)
     [16.5](#section-16.5). State Diagram  . . . . . . . . . . . . . . . . . . . . . . [76](#page-76)
   [17](#section-17). Deployment Considerations  . . . . . . . . . . . . . . . . . . [77](#page-77)
     [17.1](#section-17.1). Ingress Filtering  . . . . . . . . . . . . . . . . . . . . [77](#page-77)
     [17.2](#section-17.2). Mapping Quota  . . . . . . . . . . . . . . . . . . . . . . [77](#page-77)
   [18](#section-18). Security Considerations  . . . . . . . . . . . . . . . . . . . [78](#page-78)
     [18.1](#section-18.1). Simple Threat Model  . . . . . . . . . . . . . . . . . . . [78](#page-78)
       [18.1.1](#section-18.1.1). Attacks Considered . . . . . . . . . . . . . . . . . . [79](#page-79)
       18.1.2. Deployment Examples Supporting the Simple Threat
               Model  . . . . . . . . . . . . . . . . . . . . . . . . [79](#page-79)
     [18.2](#section-18.2). Advanced Threat Model  . . . . . . . . . . . . . . . . . . [80](#page-80)
     [18.3](#section-18.3). Residual Threats . . . . . . . . . . . . . . . . . . . . . [80](#page-80)
       [18.3.1](#section-18.3.1). Denial of Service  . . . . . . . . . . . . . . . . . . [80](#page-80)
       [18.3.2](#section-18.3.2). Ingress Filtering  . . . . . . . . . . . . . . . . . . [81](#page-81)
       [18.3.3](#section-18.3.3). Mapping Theft  . . . . . . . . . . . . . . . . . . . . [81](#page-81)
       [18.3.4](#section-18.3.4). Attacks against Server Discovery . . . . . . . . . . . [81](#page-81)
   [19](#section-19). IANA Considerations  . . . . . . . . . . . . . . . . . . . . . [82](#page-82)
     [19.1](#section-19.1). Port Number  . . . . . . . . . . . . . . . . . . . . . . . [82](#page-82)
     [19.2](#section-19.2). Opcodes  . . . . . . . . . . . . . . . . . . . . . . . . . [82](#page-82)
     [19.3](#section-19.3). Result Codes . . . . . . . . . . . . . . . . . . . . . . . [82](#page-82)
     [19.4](#section-19.4). Options  . . . . . . . . . . . . . . . . . . . . . . . . . [82](#page-82)
   [20](#section-20). Acknowledgments  . . . . . . . . . . . . . . . . . . . . . . . [83](#page-83)
   [21](#section-21). References . . . . . . . . . . . . . . . . . . . . . . . . . . [84](#page-84)
     [21.1](#section-21.1). Normative References . . . . . . . . . . . . . . . . . . . [84](#page-84)
     [21.2](#section-21.2). Informative References . . . . . . . . . . . . . . . . . . [84](#page-84)
   [Appendix A](#appendix-A). NAT-PMP Transition . . . . . . . . . . . . . . . . . . [87](#page-87)
...
[1](#section-1).  Introduction
   ...
   Discovery \[[RFC6763](./rfc6763 "\"DNS-Based Service Discovery\"")\] would use DNS Update \[[RFC2136](./rfc2136 "\"Dynamic Updates in the Domain Name System (DNS UPDATE)\"")\] \[[RFC3007](./rfc3007 "\"Secure Domain Name System (DNS) Dynamic Update\"")\].  PCP
...
[2.1](#section-2.1).  Deployment Scenarios

   PCP can be used in various deployment scenarios, including:

   o  Basic NAT \[[RFC3022](./rfc3022 "\"Traditional IP Network Address Translator (Traditional NAT)\"")\]

   o  Network Address and Port Translation \[[RFC3022](./rfc3022 "\"Traditional IP Network Address Translator (Traditional NAT)\"")\], such as commonly
      deployed in residential NAT devices

   o  Carrier-Grade NAT \[[RFC6888](./rfc6888 "\"Common Requirements for Carrier-Grade NATs (CGNs)\"")\]

   o  Dual-Stack Lite (DS-Lite) \[[RFC6333](./rfc6333 "\"Dual-Stack Lite Broadband Deployments Following IPv4 Exhaustion\"")\]

   o  NAT that is Layer-2 Aware \[[L2NAT](#ref-L2NAT "\"Layer2-Aware NAT\"")\]

   o  Dual-Stack Extra Lite \[[RFC6619](./rfc6619 "\"Scalable Operation of Address Translators with Per-Interface Bindings\"")\]

   o  NAT64, both Stateless \[[RFC6145](./rfc6145 "\"IP/ICMP Translation Algorithm\"")\] and Stateful \[[RFC6146](./rfc6146 "\"Stateful NAT64: Network Address and Protocol Translation from IPv6 Clients to IPv4 Servers\"")\]

   o  IPv4 and IPv6 simple firewall control \[[RFC6092](./rfc6092 "\"Recommended Simple Security Capabilities in Customer Premises Equipment (CPE) for Providing Residential IPv6 Internet Service\"")\]

   o  IPv6-to-IPv6 Network Prefix Translation (NPTv6) \[[RFC6296](./rfc6296 "\"IPv6-to-IPv6 Network Prefix Translation\"")\]

[2.2](#section-2.2).  Supported Protocols
   ...
   UDP, Stream Control Transmission Protocol (SCTP) \[[RFC4960](./rfc4960 "\"Stream Control Transmission Protocol\"")\], and
   Datagram Congestion Control Protocol (DCCP) \[[RFC4340](./rfc4340 "\"Datagram Congestion Control Protocol (DCCP)\"")\]).  Protocols
   that do not use a port number (e.g., Resource Reservation Protocol
   (RSVP), IP Encapsulating Security Payload (ESP) \[[RFC4303](./rfc4303 "\"IP Encapsulating Security Payload (ESP)\"")\], ICMP, and
   ICMPv6) are supported for IPv4 firewall, IPv6 firewall, and NPTv6
   functions, but are out of scope for any NAT functions.

[2.3](#section-2.3).  Single-Homed Customer Premises Network
...
[3](#section-3).  Terminology
   ...
   "Key words for use in RFCs to Indicate Requirement Levels" \[[RFC2119](./rfc2119 "\"Key words for use in RFCs to Indicate Requirement Levels\"")\].
   ...
   Remote Peer Host:
      ...
      \[[RFC4787](./rfc4787 "\"Network Address Translation (NAT) Behavioral Requirements for Unicast UDP\"")\].
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   PCP Client:
      ...
      Gateway Device (UPnP IGDv1 \[[IGDv1](#ref-IGDv1 "\"WANIPConnection:1\"")\]) to PCP is another example of a
...
[4](#section-4).  Relationship between PCP Server and Its PCP-Controlled Device
   ...
   Internet (e.g., UDP port 500 and IP ESP) \[[RFC6092](./rfc6092 "\"Recommended Simple Security Capabilities in Customer Premises Equipment (CPE) for Providing Residential IPv6 Internet Service\"")\].  Such default
...
[5](#section-5).  Note on Fixed-Size Addresses
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   address \[[RFC4291](./rfc4291 "\"IP Version 6 Addressing Architecture\"")\] is used (::ffff:0:0/96).  This has the first 80
   ...
   IPv6 address \[[RFC4291](./rfc4291 "\"IP Version 6 Addressing Architecture\"")\] would not be valid for a mapping.
...
[6](#section-6).  Protocol Design Note
...
[7](#section-7).  Common Request and Response Header Format
   ...
   Opcodes defined in this document is described in Sections [10](#section-10), [11](#section-11), and
   12.
...
[7.1](#section-7.1).  Request Header
   ...
   Version:  This document specifies protocol version 2.  PCP clients
      ...
      field is used for version negotiation as described in [Section 9](#section-9).

   R: Indicates Request (0) or Response (1).

   Opcode:  A 7-bit value specifying the operation to be performed.  MAP
      and PEER Opcodes are defined in Sections [11](#section-11) and [12](#section-12).
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   PCP Client's IP Address:  The source IPv4 or IPv6 address in the IP
      ...
      the PCP-controlled NAT or firewall device.  See [Section 8.1](#section-8.1).
   ...
   PCP Options:  Zero, one, or more options that are legal for both a
      PCP request and for this Opcode.  See [Section 7.3](#section-7.3).

[7.2](#section-7.2).  Response Header
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   Result Code:  The result code for this response.  See [Section 7.4](#section-7.4) for
   ...
   Epoch Time:  The server's Epoch Time value.  See [Section 8.5](#section-8.5) for
   ...
   PCP Options:  Zero, one, or more options that are legal for both a
      PCP response and for this Opcode.  See [Section 7.3](#section-7.3).

[7.3](#section-7.3).  Options
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   to implement code to generate the THIRD\_PARTY option, and a PCP
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   server, the PCP server MUST respond with the MALFORMED\_OPTION result
   code.  If the PCP server encounters an invalid option (e.g., PCP
   option length is longer than the UDP packet length), the error
   MALFORMED\_OPTION SHOULD be returned (rather than MALFORMED\_REQUEST),
   ...
   message size, the PCP server SHOULD respond with MALFORMED\_REQUEST.
   ...
   generate an error response with code MALFORMED\_OPTION.
   ...
   return the error MALFORMED\_OPTION if the option contents are
   malformed, or UNSUPP\_OPTION if the option is unrecognized,
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  The PREFER\_FAILURE option is valid only for the MAP Opcode (for
      the PEER Opcode, similar semantics are automatically implied).

[7.4](#section-7.4).  Result Codes
   ...
   1  UNSUPP\_VERSION: The version number at the start of the PCP Request
      header is not recognized by this PCP server.  This is a long
      lifetime error.  This document describes PCP version 2.

   2  NOT\_AUTHORIZED: The requested operation is disabled for this PCP
   ...
   5  UNSUPP\_OPTION: Unsupported option.  This error only occurs if the
      option is in the mandatory-to-process range.  This is a long
      lifetime error.

   6  MALFORMED\_OPTION: Malformed option (e.g., appears too many times,
      invalid length).  This is a long lifetime error.

   7  NETWORK\_FAILURE: The PCP server or the device it controls is
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   8  NO\_RESOURCES: Request is well-formed and valid, but the server has
      ...
      error, different from USER\_EX\_QUOTA.  This can be used as a catch-
      all error, should no other error message be suitable.  This is a
      short lifetime error.

   9  UNSUPP\_PROTOCOL: Unsupported transport protocol, e.g., SCTP in a
      NAT that handles only UDP and TCP.  This is a long lifetime error.

   10 USER\_EX\_QUOTA: This attempt to create a new mapping would exceed
      this subscriber's port quota.  This is a short lifetime error.

   11 CANNOT\_PROVIDE\_EXTERNAL: The suggested external port and/or
      external address cannot be provided.  This error MUST only be
      returned for:
      \*  MAP requests that included the PREFER\_FAILURE option
         (normal MAP requests will return an available external port)
      \*  MAP requests for the SCTP protocol (PREFER\_FAILURE is implied)
      \*  PEER requests

      See [Section 13.2](#section-13.2) for details of the PREFER\_FAILURE Option.  The
      error lifetime depends on the reason for the failure.

   12 ADDRESS\_MISMATCH: The source IP address of the request packet does
   ...
   13 EXCESSIVE\_REMOTE\_PEERS: The PCP server was not able to create the
      filters in this request.  This result code MUST only be returned
      if the MAP request contained the FILTER option.  See [Section 13.3](#section-13.3)
      for details of the FILTER Option.  This is a long lifetime error.

[8](#section-8).  General PCP Operation

   PCP messages MUST be sent over UDP \[[RFC0768](./rfc0768 "\"User Datagram Protocol\"")\].  Every PCP request
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   sends, most notably to support rapid recovery ([Section 14](#section-14)).  Also see
   the Protocol Design Note ([Section 6](#section-6)).

[8.1](#section-8.1).  General PCP Client: Generating a Request
   ...
   [Section 11](#section-11), and procedures specific to the PEER Opcode are described
   in [Section 12](#section-12).
   ...
   port SHOULD be randomly generated \[[RFC6056](./rfc6056 "\"Recommendations for Transport-Protocol Port Randomization\"")\].
   ...
   [Section 16.4](#section-16.4) for how this can be coded.  This is used to detect an
...
[8.1.1](#section-8.1.1).  PCP Client Retransmission
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   [Section 11.2.1](#section-11.2.1), "Renewing a Mapping", and sends subsequent PCP
...
[8.2](#section-8.2).  General PCP Server: Processing a Request
   ...
   A PCP server MUST only accept normal (non-THIRD\_PARTY) PCP requests
   ...
   server that supports THIRD\_PARTY requests MAY be configured to accept
   THIRD\_PARTY requests on other configured interfaces (see [Section 13.1](#section-13.1)
   for details on the THIRD\_PARTY Option).
   ...
   simply generates the UNSUPP\_OPCODE response and copies fields from
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   response is generated with the UNSUPP\_VERSION result code, and the
   Version Negotiation steps detailed in [Section 9](#section-9) are followed.
   ...
   invalid and a MALFORMED\_REQUEST response is generated, and the
   ...
   the error ADDRESS\_MISMATCH MUST be returned.  This is done to detect
...
[8.3](#section-8.3).  General PCP Client: Processing a Response
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   If the error code is UNSUPP\_VERSION, Version Negotiation processing
   continues as described in [Section 9](#section-9).
   ...
   Time field (see [Section 8.5](#section-8.5)) to determine if it needs to restore its
   ...
   change on the PCP server, later send a NOT\_AUTHORIZED response.  A
   ...
   If the error ADDRESS\_MISMATCH is received, it indicates the presence
   ...
   absurdly large values, e.g., 5 years), detailed in [Section 15](#section-15),
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   error (as limited by the sanity checking detailed in [Section 15](#section-15)).
...
[8.4](#section-8.4).  Multi-Interface Issues
   ...
   is the case for a Global Unicast Address (GUA) \[[RFC3587](./rfc3587 "\"IPv6 Global Unicast Address Format\"")\] or limited
   scope as is the case for a Unique Local Address (ULA) \[[RFC4193](./rfc4193 "\"Unique Local IPv6 Unicast Addresses\"")\]).
   ...
   addresses \[[RFC4941](./rfc4941 "\"Privacy Extensions for Stateless Address Autoconfiguration in IPv6\"")\] are used for PCP mappings, a new PCP request will
   ...
   (e.g., private addresses \[[RFC1918](./rfc1918 "\"Address Allocation for Private Internets\"")\]) MAY be used as the source
   interface when generating a PCP request.

[8.5](#section-8.5).  Epoch
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  If this is the first PCP response the client has received from
      ...
      \*  If the current PCP server Epoch time (curr\_server\_time) is less
         than the previously received PCP server Epoch time
         (prev\_server\_time) by more than one second, then the client
         ...
         +  The client computes the difference between its
            current local time (curr\_client\_time) and the
            time the previous PCP response was received from this PCP
            server (prev\_client\_time):
            client\_delta = curr\_client\_time - prev\_client\_time;

         +  The client computes the difference between the
            current PCP server Epoch time (curr\_server\_time) and the
            previously received Epoch time (prev\_server\_time):
            server\_delta = curr\_server\_time - prev\_server\_time;

         +  If client\_delta+2 < server\_delta - server\_delta/16
            or server\_delta+2 < client\_delta - client\_delta/16,
   ...
   o  The client records the current time values for use in its next
      comparison:
      prev\_client\_time = curr\_client\_time
      prev\_server\_time = curr\_server\_time
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  The client clock MUST never go backwards.  If curr\_client\_time is
      found to be less than prev\_client\_time, then this is a client bug,
      and how the client deals with this client bug is implementation
      specific.

   o  The calculations above are constructed to allow client\_delta and
      server\_delta to be computed as unsigned integer values.
...
[9](#section-9).  Version Negotiation
   ...
   code UNSUPP\_VERSION, the client MAY log an error message to inform
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   3.  If the server does not support that version, it replies giving a
       result containing the result code UNSUPP\_VERSION, and the closest
   ...
   4.  If the client receives an UNSUPP\_VERSION result containing a
       ...
       server (until a possible future UNSUPP\_VERSION response if the
       server is later updated, at which point the version negotiation
       process repeats).  If the version number in the UNSUPP\_VERSION
       response is zero then that means this is a NAT-PMP server
       \[[RFC6886](./rfc6886 "\"NAT Port Mapping Protocol (NAT-PMP)\"")\], and a client MAY choose to communicate with it using
       the older NAT-PMP protocol, as described in [Appendix A](#appendix-A).

   5.  If the client receives an UNSUPP\_VERSION result containing a
...
[10](#section-10).  Introduction to MAP and PEER Opcodes
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  a host operating a client and wanting to optimize the application
      keepalive traffic ([Section 10.3](#section-10.3)); and

   o  a host operating a client and wanting to restore lost state in its
      NAT ([Section 10.4](#section-10.4)).

   These are discussed in the following sections, and a (non-normative)
   state diagram is provided in [Section 16.5](#section-16.5).

   When operating a server (see Sections [10.1](#section-10.1) and [10.2](#section-10.2)), the PCP client
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   address of the PCP request, except when the THIRD\_PARTY option is
   used.
...
[10.1](#section-10.1).  For Operating a Server
   ...
   using the MAP Opcode, as described in [Section 11](#section-11); (b) publish that
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   operate a server:
    ...
    getsockname(s, &internal\_sockaddr, ...);
    bzero(&external\_sockaddr, sizeof(external\_sockaddr));

    while (1)
        {
        /\* Note: The "time\_to\_send\_pcp\_request()" check below includes:
         ...
         \*/
        if (time\_to\_send\_pcp\_request())
            pcp\_send\_map\_request(internal\_sockaddr.sin\_port,
                internal\_sockaddr.sin\_addr,
                &external\_sockaddr, /\* will be zero the first time \*/
                requested\_lifetime, &assigned\_lifetime);

        if (pcp\_response\_received())
            update\_rendezvous\_server("Client Ident", external\_sockaddr);

        if (received\_incoming\_connection\_or\_packet())
            process\_it(s);

        if (other\_work\_to\_do())
            do\_it();

        /\* ... \*/

        block\_until\_we\_need\_to\_do\_something\_else();
        }
...
[10.2](#section-10.2).  For Operating a Symmetric Client/Server

   A host operating a client and server on the same port (e.g.,
   Symmetric RTP \[[RFC4961](./rfc4961 "\"Symmetric RTP / RTP Control Protocol (RTCP)\"")\] or SIP Symmetric Response Routing (rport)
   \[[RFC3581](./rfc3581 "\"An Extension to the Session Initiation Protocol (SIP) for Symmetric Response Routing\"")\]) first establishes a local listener, (usually) sends the
   ...
   server using the PCP MAP Opcode, as described in [Section 11](#section-11), and
   ...
   port.
      ...
      using PCP with EDM NATs, see [Section 16.1](#section-16.1).
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   symmetric client and server:
    ...
    while (1)
        ...
        if (need\_to\_make\_outgoing\_connection())
            make\_outgoing\_connection(s, ...);
...
[10.3](#section-10.3).  For Reducing NAT or Firewall Keepalive Messages
   ...
   Opcode as described in [Section 12](#section-12) to learn and/or extend the lifetime
   of its mapping.
   ...
   messages:
    ...
    while (1)
        ...
        /\* Note: The "time\_to\_send\_pcp\_request()" check below includes:
         ...
         \*/
        if (time\_to\_send\_pcp\_request())
            pcp\_send\_peer\_request(internal\_sockaddr.sin\_port,
                internal\_sockaddr.sin\_addr,
                &external\_sockaddr, /\* will be zero the first time \*/
                remote\_peer, requested\_lifetime, &assigned\_lifetime);

        if (data\_to\_send())
            send\_it(s);

        if (received\_incoming\_data())
            process\_it(s);
...
[10.4](#section-10.4).  For Restoring Lost Implicit TCP Dynamic Mapping State
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   port (e.g., by binding the port using INADDR\_ANY, or using
   SO\_EXCLUSIVEADDRUSE or similar) before sending their PCP MAP request,
...
[11.1](#section-11.1).  MAP Operation Packet Formats
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   Mapping Nonce:  Random value chosen by the PCP client.  See
      [Section 11.2](#section-11.2), "Generating a MAP Request".  Zero is a legal value
      (but unlikely, occurring in roughly one in 2^96 requests).

   Protocol:  Upper-layer protocol associated with this Opcode.  Values
      are taken from the IANA protocol registry \[[proto\_numbers](#ref-proto_numbers "\"Protocol Numbers\"")\].  For
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   Suggested External IP Address:  Suggested external IPv4 or IPv6
      ...
      the address-family-specific all-zeros address (see [Section 5](#section-5)).

   The internal address for the request is the source IP address of the
   PCP request message itself, unless the THIRD\_PARTY option is used.
...
[11.2](#section-11.2).  Generating a MAP Request
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   numbers \[[RFC4086](./rfc4086 "\"Randomness Requirements for Security\"")\], and is used as part of the validation of PCP
...
[11.2.1](#section-11.2.1).  Renewing a Mapping
   ...
   otherwise, it will be removed by the PCP server (see [Section 15](#section-15),
...
[11.3](#section-11.3).  Processing a MAP Request
   ...
   request are copied into the MAP response.  The THIRD\_PARTY option, if
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  If both the protocol and internal port are non-zero, it indicates
      ...
      not support the protocol, the UNSUPP\_PROTOCOL error MUST be
      returned.
   ...
   o  If the protocol is non-zero and the internal port is zero, it
      ...
      its entirety, the UNSUPP\_PROTOCOL error MUST be returned.
   ...
   o  If both the protocol and internal port are zero, it indicates a
      ...
      cannot be fulfilled in its entirety, the UNSUPP\_PROTOCOL error
      MUST be returned.

   o  If the protocol is zero and the internal port is non-zero, then
      the request is invalid and the PCP server MUST return a
      MALFORMED\_REQUEST error to the client.

   If the requested lifetime is zero, it indicates a request to delete
   an existing mapping.

   Further processing of the lifetime is described in [Section 15](#section-15),
   "Mapping Lifetime and Deletion".

   If operating in the Simple Threat Model ([Section 18.1](#section-18.1)), and the
   ...
   request MUST be rejected with a NOT\_AUTHORIZED error with the
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   PREFER\_FAILURE option is included in a request with lifetime=0), the
   request is invalid and generates a MALFORMED\_OPTION error.
   ...
   stateless NAT64, 1:1 NAT44, and NPTv6 \[[RFC6296](./rfc6296 "\"IPv6-to-IPv6 Network Prefix Translation\"")\], all of which modify
   ...
   1.  If the MAP request contains the PREFER\_FAILURE option, but the
       ...
       return CANNOT\_PROVIDE\_EXTERNAL.
   ...
   3.  If the existing mapping is explicit dynamic inbound (created by a
       ...
       existing mapping, in accordance with [Section 15](#section-15), "Mapping
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   o  If the request contained the PREFER\_FAILURE option, then the PCP
      server MUST return CANNOT\_PROVIDE\_EXTERNAL.

   o  If the request did not contain the PREFER\_FAILURE option, and the
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   If this limit is exceeded, the result code USER\_EX\_QUOTA is returned.
...
[11.4](#section-11.4).  Processing a MAP Response
   ...
   or other IP address specified via the THIRD\_PARTY option), the
   ...
   server will send a Mapping Update ([Section 14.2](#section-14.2)) if the mapping
   changes (e.g., due to IP renumbering).

   If the result code is NO\_RESOURCES and the request was for the
   ...
   (limited) value of the lifetime.  If the result code is NO\_RESOURCES
   ...
   by sending another MAP request, exactly as described in [Section 11.2](#section-11.2),
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   [Section 16.3.1](#section-16.3.1), "Recreating Mappings".
...
[11.5](#section-11.5).  Address Change Events
...
[11.6](#section-11.6).  Learning the External IP Address Alone

   NAT-PMP \[[RFC6886](./rfc6886 "\"NAT Port Mapping Protocol (NAT-PMP)\"")\] includes a mechanism to allow clients to learn the
...
[12.1](#section-12.1).  PEER Operation Packet Formats
   ...
   Mapping Nonce:  Random value chosen by the PCP client.  See
      [Section 12.2](#section-12.2), "Generating a PEER Request".  Zero is a legal value
      (but unlikely, occurring in roughly one in 2^96 requests).
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   Suggested External IP Address:  Suggested external IP address for the
      ...
      specific all-zeros address (see [Section 5](#section-5)).
   ...
   Remote Peer IP Address:  Remote peer's IP address.  This is from the
      ...
      represented using the IPv4-mapped address syntax ([Section 5](#section-5)).
   ...
   Note that semantics similar to the PREFER\_FAILURE option are
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   CANNOT\_PROVIDE\_EXTERNAL error response.  The PREFER\_FAILURE option is
   neither required nor allowed in PEER requests, and if a PCP server
   receives a PEER request containing the PREFER\_FAILURE option it MUST
...
[12.2](#section-12.2).  Generating a PEER Request
   ...
   described in [Section 10.3](#section-10.3)).
...
[12.3](#section-12.3).  Processing a PEER Request
   ...
   created, and a MALFORMED\_REQUEST error result is returned.
   ...
   (see [Section 16.3.1](#section-16.3.1), "Recreating Mappings").  Thereafter, this PEER-
   ...
   error CANNOT\_PROVIDE\_EXTERNAL is returned.
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   with a NOT\_AUTHORIZED error with the lifetime of the error indicating
   ...
   [Section 15](#section-15), "Mapping Lifetime and Deletion".  Sending a PEER request
...
[12.4](#section-12.4).  Processing a PEER Response
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   Update ([Section 14.2](#section-14.2)) if the mapping changes (e.g., due to IP
   renumbering).
   ...
   as described in [Section 11.2.1](#section-11.2.1).
...
[13](#section-13).  Options for MAP and PEER Opcodes
...
[13.1](#section-13.1).  THIRD\_PARTY Option for MAP and PEER Opcodes
   ...
   Due to security concerns with the THIRD\_PARTY option, this option
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   the THIRD\_PARTY option to the appropriate PCP server.
   ...
   A THIRD\_PARTY option MUST NOT contain the same address as the source
   address of the packet.  This is because many PCP servers may not
   implement the THIRD\_PARTY option at all, and with those servers a
   client redundantly using the THIRD\_PARTY option to specify its own IP
   address would cause such mapping requests to fail where they would
   otherwise have succeeded.  A PCP server receiving a THIRD\_PARTY
   option specifying the same address as the source address of the
   packet MUST return a MALFORMED\_REQUEST result code.
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   the THIRD\_PARTY option.  If this option is permitted, properly
   ...
   MAP request with a THIRD\_PARTY option, it MUST generate a
   UNSUPP\_OPTION response.
   ...
   implementing a PCP server be configured to permit the THIRD\_PARTY
   ...
   UNSUPP\_OPTION error.

   Note that the THIRD\_PARTY option is not needed for today's common
   ...
   When a PCP client is using the THIRD\_PARTY option to make and
...
[13.2](#section-13.2).  PREFER\_FAILURE Option for MAP Opcode
   ...
   PREFER\_FAILURE is never necessary for a PCP client to manage mappings
   ...
   IGDv1 interworking \[[PNP-IGD-PCP](#ref-PNP-IGD-PCP "\"Universal Plug and Play (UPnP) Internet Gateway Device (IGD)- Port Control Protocol (PCP) Interworking Function\"")\], where the semantics of UPnP IGDv1
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   The result code CANNOT\_PROVIDE\_EXTERNAL is returned if the suggested
   ...
   lifetime of the conflicting mapping + TIME\_WAIT \[[RFC0793](./rfc0793 "\"Transmission Control Protocol\"")\], rounded up
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   If a PCP request contains the PREFER\_FAILURE option and has zero in
   the Suggested External Port field, then it is invalid.  The PCP
   server MUST reject such a message with the MALFORMED\_OPTION error
   code.

   PCP servers MAY choose to rate-limit their handling of PREFER\_FAILURE
   requests, to protect themselves from a rapid flurry of 65535
   consecutive PREFER\_FAILURE requests from clients probing to discover
   which external ports are available.

   There can exist a race condition between the MAP Opcode using the
   PREFER\_FAILURE option and Mapping Update ([Section 14.2](#section-14.2)).  For
   ...
   Request using the PREFER\_FAILURE option, the PCP server could send a
...
[13.3](#section-13.3).  FILTER Option for MAP Opcode
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   the PCP server to return the MALFORMED\_OPTION result code.
   ...
   EXCESSIVE\_REMOTE\_PEERS, and the state on the PCP server is unchanged.

   All PCP servers MUST support at least one filter per MAP mapping.

[14](#section-14).  Rapid Recovery
...
[14.1](#section-14.1).  ANNOUNCE Opcode
...
[14.1.1](#section-14.1.1).  ANNOUNCE Operation
...
[14.1.2](#section-14.1.2).  Generating and Processing a Solicited ANNOUNCE Message
...
[14.1.3](#section-14.1.3).  Generating and Processing an Unsolicited ANNOUNCE Message
   ...
   [Section 8.3](#section-8.3) will accept the message).  This message is most typically
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   The SO\_REUSEPORT socket option or equivalent should be used for the
...
[14.2](#section-14.2).  PCP Mapping Update
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   contained the PREFER\_FAILURE option, and the same external IP
   address, protocol, and port cannot be provided, the error
   CANNOT\_PROVIDE\_EXTERNAL SHOULD be sent.  If the earlier associated
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   For PEER responses giving a CANNOT\_PROVIDE\_EXTERNAL error, this would
...
[15](#section-15).  Mapping Lifetime and Deletion
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   (typically, the maximum TCP segment lifetime of 2 minutes \[[RFC0793](./rfc0793 "\"Transmission Control Protocol\"")\]).
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   implicit dynamic mapping (e.g., 2 minutes for UDP \[[RFC4787](./rfc4787 "\"Network Address Translation (NAT) Behavioral Requirements for Unicast UDP\"")\] and 124
   minutes for TCP \[[RFC5382](./rfc5382 "\"NAT Behavioral Requirements for TCP\"")\]).  However, within these time windows, the
...
[15.1](#section-15.1).  Lifetime Processing for the MAP Opcode
   ...
   NOT\_AUTHORIZED.  If the PCP client attempts to delete a mapping that
   ...
   TCP FIN).  Note the THIRD\_PARTY option ([Section 13.1](#section-13.1)), if authorized,
...
[16](#section-16).  Implementation Considerations

   [Section 16](#section-16) provides non-normative guidance that may be useful to
   implementers.

[16.1](#section-16.1).  Implementing MAP with EDM Port-Mapping NAT
   ...
   \[[RFC4787](./rfc4787 "\"Network Address Translation (NAT) Behavioral Requirements for Unicast UDP\"")\]\[RFC5382\].
...
[16.2](#section-16.2).  Lifetime of Explicit and Implicit Dynamic Mappings
...
[16.3](#section-16.3).  PCP Failure Recovery
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   document \[[PCP-FAIL](#ref-PCP-FAIL "\"Port Control Protocol (PCP) Failure Scenarios\"")\].

[16.3.1](#section-16.3.1).  Recreating Mappings
   ...
   the expected range ([Section 8.5](#section-8.5)), indicating that a reboot or similar
...
[16.3.2](#section-16.3.2).  Maintaining Mappings
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   or port is different from the previous values (see Sections [10.1](#section-10.1) and
   11.5).

[16.3.3](#section-16.3.3).  SCTP
   ...
   numbers are not changed \[[SCTPNAT](#ref-SCTPNAT "\"Stream Control Transmission Protocol (SCTP) Network Address Translation\"")\].  Outbound dynamic SCTP mappings
   ...
   [Section 11.3](#section-11.3), "Processing a MAP Request".  In the event that the
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   NAT MUST return a CANNOT\_PROVIDE\_EXTERNAL error to the requesting PCP
...
[16.4](#section-16.4).  Source Address Replicated in PCP Header
...
[16.5](#section-16.5).  State Diagram
   ...
   state machine shown below.  This state diagram is non-normative.
       ...
       CLOSE\_MSG or
      (NO\_TRAFFIC and EXPIRY)   +---------+  NO\_TRAFFIC and EXPIRY
                +-------------->|         |<------------+
                |               |NO\_ENTRY |             |
                |   +-----------|         |---------+   |
                |   |           +---------+         |   |
   ...
   The meanings of the states and events are:
      ...
      NO\_ENTRY:  Invalid state represents Entry does not exist.  This is
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
      ...
      CLOSE\_MSG:  Protocol messages from the client or server to close
...
[17](#section-17).  Deployment Considerations

[17.1](#section-17.1).  Ingress Filtering
   ...
   Therefore, ingress filtering \[[RFC2827](./rfc2827 "\"Network Ingress Filtering: Defeating Denial of Service Attacks which employ IP Source Address Spoofing\"")\] SHOULD be used on the path
   between the internal host and the PCP server to prevent the injection
   of spoofed packets onto that path.

[17.2](#section-17.2).  Mapping Quota
...
[18](#section-18).  Security Considerations
...
[18.1](#section-18.1).  Simple Threat Model
   ...
   (3) the THIRD\_PARTY option is not supported.  PCP servers can also
   ...
   implement a PCP security mechanism described in [Section 18.2](#section-18.2) MUST
...
[18.1.1](#section-18.1.1).  Attacks Considered
   ...
   o  If the THIRD\_PARTY option is supported, this also allows an
      ...
      attack.  One example of how the THIRD\_PARTY option could grant an
...
[18.1.2](#section-18.1.2).  Deployment Examples Supporting the Simple Threat Model

   This section offers two examples of how the Simple Threat Model can
   be supported in real-world deployment scenarios.

[18.1.2.1](#section-18.1.2.1).  Residential Gateway Deployment
   ...
   [Section 18.1](#section-18.1) above.
...
[18.2](#section-18.2).  Advanced Threat Model
   ...
   o  Implementations that wish to support any deployment scenario that
      does not meet the constraints described in [Section 18.1](#section-18.1).
   ...
   the constraints described in [Section 18.1](#section-18.1) when processing
   unauthenticated requests.

[18.3](#section-18.3).  Residual Threats
...
[18.3.1](#section-18.3.1).  Denial of Service
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   hosts.  Thus, [Section 17.2](#section-17.2) recommends that hosts be limited to a
...
[18.3.3](#section-18.3.3).  Mapping Theft
...
[18.3.4](#section-18.3.4).  Attacks against Server Discovery
...
[19](#section-19).  IANA Considerations

   IANA has performed the following actions.

[19.1](#section-19.1).  Port Number

   PCP uses ports 5350 and 5351, previously assigned by IANA to NAT-PMP
   \[[RFC6886](./rfc6886 "\"NAT Port Mapping Protocol (NAT-PMP)\"")\].  IANA has reassigned those ports to PCP.

[19.2](#section-19.2).  Opcodes
   ...
   0-127, initially populated with the values:
           ...
           1                MAP
           2                PEER
           3-31             Standards Action \[[RFC5226](./rfc5226)\]
           32-63            Specification Required \[[RFC5226](./rfc5226)\]
           96-126           Reserved for Private Use \[[RFC5226](./rfc5226)\]
           127              Reserved, Standards Action \[[RFC5226](./rfc5226)\]

   The value 127 is Reserved and may be assigned via Standards Action
   \[[RFC5226](./rfc5226)\].  The values in the range 3-31 can be assigned via
   Standards Action \[[RFC5226](./rfc5226)\], 32-63 via Specification Required
   \[[RFC5226](./rfc5226)\], and the range 96-126 is for Private Use \[[RFC5226](./rfc5226)\].

[19.3](#section-19.3).  Result Codes

   IANA has created a new registry for PCP result codes, numbered 0-255,
   initially populated with the result codes from [Section 7.4](#section-7.4).  The
   ...
   \[[RFC5226](./rfc5226)\], 128-191 via Specification Required \[[RFC5226](./rfc5226)\], and the
   range 191-254 is for Private Use \[[RFC5226](./rfc5226)\].

[19.4](#section-19.4).  Options
   ...
   contains the options described in [Section 13](#section-13).  The option values 0,
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   created via Standards Action \[[RFC5226](./rfc5226)\], the ranges 64-95 and 192-223
   are for Specification Required \[[RFC5226](./rfc5226)\], and the ranges 96-126 and
   224-254 are for Private Use \[[RFC5226](./rfc5226)\].
...
[21](#section-21).  References

[21.1](#section-21.1).  Normative References

   \[RFC0768\]        Postel, J., "User Datagram Protocol", STD 6,
                    [RFC 768](./rfc768), August 1980.
   ...
   \[RFC2827\]        Ferguson, P. and D. Senie, "Network Ingress
                    ...
                    employ IP Source Address Spoofing", [BCP 38](https://www.rfc-editor.org/bcp/bcp38),
                    [RFC 2827](./rfc2827), May 2000.

   \[RFC4086\]        Eastlake, D., Schiller, J., and S. Crocker,
                    "Randomness Requirements for Security", [BCP 106](https://www.rfc-editor.org/bcp/bcp106),
                    [RFC 4086](./rfc4086), June 2005.

   \[RFC4193\]        Hinden, R. and B. Haberman, "Unique Local IPv6
                    Unicast Addresses", [RFC 4193](./rfc4193), October 2005.
   ...
   \[RFC5226\]        Narten, T. and H. Alvestrand, "Guidelines for
                    ...
                    [BCP 26](https://www.rfc-editor.org/bcp/bcp26), [RFC 5226](./rfc5226), May 2008.

   \[RFC6056\]        Larsen, M. and F. Gont, "Recommendations for
                    Transport-Protocol Port Randomization", [BCP 156](https://www.rfc-editor.org/bcp/bcp156),
                    [RFC 6056](./rfc6056), January 2011.

   \[proto\_numbers\]  IANA, "Protocol Numbers", 2011,
                    <[http://www.iana.org/assignments/protocol-numbers](http://www.iana.org/assignments/protocol-numbers)\>.

[21.2](#section-21.2).  Informative References

   \[IGDv1\]          UPnP Gateway Committee, "WANIPConnection:1",
                    November 2001, <[http://upnp.org/specs/gw/](http://upnp.org/specs/gw/UPnP-gw-WANIPConnection-v1-Service.pdf)
                    [UPnP-gw-WANIPConnection-v1-Service.pdf](http://upnp.org/specs/gw/UPnP-gw-WANIPConnection-v1-Service.pdf)\>.

   \[L2NAT\]          Miles, D. and M. Townsley, ["Layer2-Aware NAT"](https://www.google.com/search?sitesearch=datatracker.ietf.org%2Fdoc%2Fhtml%2F&q=inurl:draft-+%22Layer2-Aware+NAT%22), Work
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   \[RFC0793\]        Postel, J., "Transmission Control Protocol", STD 7,
                    [RFC 793](./rfc793), September 1981.

   \[RFC1918\]        Rekhter, Y., Moskowitz, R., Karrenberg, D., Groot,
                    G., and E. Lear, "Address Allocation for Private
                    Internets", [BCP 5](https://www.rfc-editor.org/bcp/bcp5), [RFC 1918](./rfc1918), February 1996.

   \[RFC2136\]        Vixie, P., Thomson, S., Rekhter, Y., and J. Bound,
                    "Dynamic Updates in the Domain Name System (DNS
                    UPDATE)", [RFC 2136](./rfc2136), April 1997.

   \[RFC3007\]        Wellington, B., "Secure Domain Name System (DNS)
                    Dynamic Update", [RFC 3007](./rfc3007), November 2000.

   \[RFC3022\]        Srisuresh, P. and K. Egevang, "Traditional IP
                    Network Address Translator (Traditional NAT)",
                    [RFC 3022](./rfc3022), January 2001.

   \[RFC3581\]        Rosenberg, J. and H. Schulzrinne, "An Extension to
                    the Session Initiation Protocol (SIP) for Symmetric
                    Response Routing", [RFC 3581](./rfc3581), August 2003.

   \[RFC3587\]        Hinden, R., Deering, S., and E. Nordmark, "IPv6
                    Global Unicast Address Format", [RFC 3587](./rfc3587),
                    August 2003.

   \[RFC4303\]        Kent, S., "IP Encapsulating Security Payload (ESP)",
                    [RFC 4303](./rfc4303), December 2005.

   \[RFC4340\]        Kohler, E., Handley, M., and S. Floyd, "Datagram
                    Congestion Control Protocol (DCCP)", [RFC 4340](./rfc4340),
                    March 2006.

   \[RFC4787\]        Audet, F. and C. Jennings, "Network Address
                    Translation (NAT) Behavioral Requirements for
                    Unicast UDP", [BCP 127](https://www.rfc-editor.org/bcp/bcp127), [RFC 4787](./rfc4787), January 2007.

   \[RFC4941\]        Narten, T., Draves, R., and S. Krishnan, "Privacy
                    Extensions for Stateless Address Autoconfiguration
                    in IPv6", [RFC 4941](./rfc4941), September 2007.

   \[RFC4960\]        Stewart, R., "Stream Control Transmission Protocol",
                    [RFC 4960](./rfc4960), September 2007.
...
[RFC 6887](./rfc6887)               Port Control Protocol (PCP)            April 2013
   ...
   \[RFC4961\]        Wing, D., "Symmetric RTP / RTP Control Protocol
                    (RTCP)", [BCP 131](https://www.rfc-editor.org/bcp/bcp131), [RFC 4961](./rfc4961), July 2007.

   \[RFC5382\]        Guha, S., Biswas, K., Ford, B., Sivakumar, S., and
                    P. Srisuresh, "NAT Behavioral Requirements for TCP",
                    [BCP 142](https://www.rfc-editor.org/bcp/bcp142), [RFC 5382](./rfc5382), October 2008.
...
[Appendix A](#appendix-A).  NAT-PMP Transition

   The Port Control Protocol (PCP) is a successor to the NAT Port
   Mapping Protocol, NAT-PMP \[[RFC6886](./rfc6886 "\"NAT Port Mapping Protocol (NAT-PMP)\"")\], and shares similar semantics,
   ...
   response will be UNSUPP\_VERSION, as indicated by the NAT-PMP
   specification \[[RFC6886](./rfc6886 "\"NAT Port Mapping Protocol (NAT-PMP)\"")\], which will cause the client to downgrade to
