...
Status of This Memo
   ...
   [http://www.rfc-editor.org/info/rfc7675](https://www.rfc-editor.org/info/rfc7675).

Perumal, et al.              Standards Track                    \[Page 1\]

* * *

[RFC 7675](./rfc7675)            STUN Usage for Consent Freshness        October 2015
...
Table of Contents
   ...
   [2](#section-2).  Applicability . . . . . . . . . . . . . . . . . . . . . . . .   [3](#page-3)
   [3](#section-3).  Terminology . . . . . . . . . . . . . . . . . . . . . . . . .   [3](#page-3)
   [4](#section-4).  Design Considerations . . . . . . . . . . . . . . . . . . . .   [4](#page-4)
   [5](#section-5).  Solution  . . . . . . . . . . . . . . . . . . . . . . . . . .   [4](#page-4)
     [5.1](#section-5.1).  Expiration of Consent . . . . . . . . . . . . . . . . . .   [5](#page-5)
     [5.2](#section-5.2).  Immediate Revocation of Consent . . . . . . . . . . . . .   [6](#page-6)
   [6](#section-6).  DiffServ Treatment for Consent  . . . . . . . . . . . . . . .   [7](#page-7)
   [7](#section-7).  DTLS Applicability  . . . . . . . . . . . . . . . . . . . . .   [7](#page-7)
   [8](#section-8).  Security Considerations . . . . . . . . . . . . . . . . . . .   [7](#page-7)
   [9](#section-9).  References  . . . . . . . . . . . . . . . . . . . . . . . . .   [8](#page-8)
     [9.1](#section-9.1).  Normative References  . . . . . . . . . . . . . . . . . .   [8](#page-8)
     [9.2](#section-9.2).  Informative References  . . . . . . . . . . . . . . . . .   [8](#page-8)
   Acknowledgements  . . . . . . . . . . . . . . . . . . . . . . . .   [9](#page-9)
   Authors' Addresses  . . . . . . . . . . . . . . . . . . . . . . .  [10](#page-10)
...
[1](#section-1).  Introduction
   ...
   Establishment (ICE) \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] connectivity checks, and periodically
...
[RFC 7675](./rfc7675)            STUN Usage for Consent Freshness        October 2015
   ...
   defined in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].

   Consent is obtained only by full ICE implementations.  An ICE-lite
   agent (as defined in [Section 2.7 of \[RFC5245\]](./rfc5245#section-2.7)) does not generate
...
[2](#section-2).  Applicability
   ...
   This document defines what it takes to obtain, maintain, and lose
   consent to send using ICE.  Sections [4.4](#section-4.4) and [5.3](#section-5.3) of \[[WebRTC-SA](#ref-WebRTC-SA)\]
...
[4](#section-4).  Design Considerations

   Although ICE requires periodic keepalive traffic to keep NAT bindings
   alive (see [Section 10 of \[RFC5245\]](./rfc5245#section-10) and also \[[RFC6263](./rfc6263 "\"Application Mechanism for Keeping Alive the NAT Mappings Associated with RTP / RTP Control Protocol (RTCP) Flows\"")\]), those
   ...
   ICE messages, as described in [Section 10 of \[RFC5245\]](./rfc5245#section-10).  STUN binding
   ...
   [Section 20.2.3 of \[RFC5245\]](./rfc5245#section-20.2.3).
   ...
   (MIKEY) \[[RFC3830](./rfc3830 "\"MIKEY: Multimedia Internet KEYing\"")\] modes, Security Descriptions \[[RFC4568](./rfc4568 "\"Session Description Protocol (SDP) Security Descriptions for Media Streams\"")\], and
   Encrypted Key Transport (EKT) \[[EKT](#ref-EKT "\"Encrypted Key Transport for Secure RTP\"")\].  Thus, in such shared keying
...
[5](#section-5).  Solution
   ...
   Initial consent to send traffic is obtained using ICE \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\].  An
...
[5.1](#section-5.1).  Expiration of Consent
   ...
   [Section 16 of \[RFC5245\]](./rfc5245#section-16), and responses to connectivity checks are
   ...
   identifier, as described in [Section 6 of \[RFC5389\]](./rfc5389#section-6).  Each STUN
...
[RFC 7675](./rfc7675)            STUN Usage for Consent Freshness        October 2015
   ...
   [Section 7.2.1 of \[RFC5389\]](./rfc5389#section-7.2.1)) with an allowance for variation in
   network delay.  The RTT value can be updated as described in
   \[[RFC5389](./rfc5389 "\"Session Traversal Utilities for NAT (STUN)\"")\].  All outstanding STUN consent transactions for a candidate
   ...
   While TCP affords some protection from off-path attackers (\[[RFC5961](./rfc5961 "\"Improving TCP's Robustness to Blind In-Window Attacks\"")\],
   \[[RFC4953](./rfc4953 "\"Defending TCP Against Spoofing Attacks\"")\]), there is still a risk an attacker could cause a TCP
   ...
   using keepalive or other techniques (see [Section 10 of \[RFC5245\]](./rfc5245#section-10) and
   see \[[RFC6263](./rfc6263 "\"Application Mechanism for Keeping Alive the NAT Mappings Associated with RTP / RTP Control Protocol (RTCP) Flows\"")\]).
...
[5.2](#section-5.2).  Immediate Revocation of Consent
...
[6](#section-6).  DiffServ Treatment for Consent
   ...
   [Section 7.1.2.4 of \[RFC5245\]](./rfc5245#section-7.1.2.4) for a given 5-tuple.

   Note:  It is possible that different Diffserv Codepoints are used by
      different media over the same transport address \[[WebRTC-QoS](#ref-WebRTC-QoS)\].
      Such a case is outside the scope of this document.

[7](#section-7).  DTLS Applicability

   The DTLS applicability is identical to what is described in
   [Section 4.2 of \[RFC7350\]](./rfc7350#section-4.2).

[8](#section-8).  Security Considerations

   This document describes a security mechanism, details of which are
   mentioned in Sections [4.1](#section-4.1) and [4.2](#section-4.2) of \[[RFC7350](./rfc7350 "\"Datagram Transport Layer Security (DTLS) as Transport for Session Traversal Utilities for NAT (STUN)\"")\].  Consent requires 96
   bits transaction ID defined in [Section 6 of \[RFC5389\]](./rfc5389#section-6) to be uniformly
   ...
   against machines is discussed in Sections [3.3](#section-3.3) and [4.2](#section-4.2) of
   \[[WebRTC-SEC](#ref-WebRTC-SEC)\].

   The security considerations discussed in \[[RFC5245](./rfc5245 "\"Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols\"")\] should also be
   taken into account.
...
[9.2](#section-9.2).  Informative References
   ...
   \[EKT\]      Mattsson, J., McGrew, D., and D. Wing, "Encrypted Key
              ...
              [draft-ietf-avtcore-srtp-ekt-03](./draft-ietf-avtcore-srtp-ekt-03), October 2014.

   \[RFC3830\]  Arkko, J., Carrara, E., Lindholm, F., Naslund, M., and K.
              Norrman, "MIKEY: Multimedia Internet KEYing", [RFC 3830](./rfc3830),
              DOI 10.17487/RFC3830, August 2004,
              <[http://www.rfc-editor.org/info/rfc3830](https://www.rfc-editor.org/info/rfc3830)\>.

   \[RFC4568\]  Andreasen, F., Baugher, M., and D. Wing, "Session
              Description Protocol (SDP) Security Descriptions for Media
              Streams", [RFC 4568](./rfc4568), DOI 10.17487/RFC4568, July 2006,
              <[http://www.rfc-editor.org/info/rfc4568](https://www.rfc-editor.org/info/rfc4568)\>.

   \[RFC4953\]  Touch, J., "Defending TCP Against Spoofing Attacks", [RFC](./rfc4953)
              [4953](./rfc4953), DOI 10.17487/RFC4953, July 2007,
              <[http://www.rfc-editor.org/info/rfc4953](https://www.rfc-editor.org/info/rfc4953)\>.

   \[RFC5961\]  Ramaiah, A., Stewart, R., and M. Dalal, "Improving TCP's
              Robustness to Blind In-Window Attacks", [RFC 5961](./rfc5961),
...
[RFC 7675](./rfc7675)            STUN Usage for Consent Freshness        October 2015
   ...
   \[RFC6062\]  Perreault, S., Ed. and J. Rosenberg, "Traversal Using
              ...
              [RFC 6062](./rfc6062), DOI 10.17487/RFC6062, November 2010,
              <[http://www.rfc-editor.org/info/rfc6062](https://www.rfc-editor.org/info/rfc6062)\>.

   \[RFC6263\]  Marjou, X. and A. Sollaud, "Application Mechanism for
              Keeping Alive the NAT Mappings Associated with RTP / RTP
              Control Protocol (RTCP) Flows", [RFC 6263](./rfc6263),
              DOI 10.17487/RFC6263, June 2011,
              <[http://www.rfc-editor.org/info/rfc6263](https://www.rfc-editor.org/info/rfc6263)\>.

   \[RFC7350\]  Petit-Huguenin, M. and G. Salgueiro, "Datagram Transport
              Layer Security (DTLS) as Transport for Session Traversal
              Utilities for NAT (STUN)", [RFC 7350](./rfc7350), DOI 10.17487/RFC7350,
              August 2014, <[http://www.rfc-editor.org/info/rfc7350](https://www.rfc-editor.org/info/rfc7350)\>.

   \[WebRTC-QoS\]
              Dhesikan, S., Jennings, C., Druta, D., Jones, P., and J.
              Polk, "DSCP and other packet markings for RTCWeb QoS",
              Work in Progress, [draft-ietf-tsvwg-rtcweb-qos-04](./draft-ietf-tsvwg-rtcweb-qos-04), July
              2015.

   \[WebRTC-SA\]
              Rescorla, E., ["WebRTC Security Architecture"](https://www.google.com/search?sitesearch=datatracker.ietf.org%2Fdoc%2Fhtml%2F&q=inurl:draft-+%22WebRTC+Security+Architecture%22), Work in
              Progress, [draft-ietf-rtcweb-security-arch-11](./draft-ietf-rtcweb-security-arch-11), March 2015.

   \[WebRTC-SEC\]
              Rescorla, E., ["Security Considerations for WebRTC"](https://www.google.com/search?sitesearch=datatracker.ietf.org%2Fdoc%2Fhtml%2F&q=inurl:draft-+%22Security+Considerations+for+WebRTC%22), Work
              in Progress, [draft-ietf-rtcweb-security-08](./draft-ietf-rtcweb-security-08), February 2015.
